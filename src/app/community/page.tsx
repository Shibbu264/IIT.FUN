...
export default function page() {
    ...
    return (
        ...
        <Banner/>
        <Getgallery/>
        <PromoSection className='md:w-[68.5%] max-md:!w-4/5 !m-11 md:!m-11 lg:!m-11 !gap-16 max-md:!gap-3' headingClassName='w-[80%]' heading="Join the Community" text="Inter IIT got you Medals?? We got you $$, If Meme-wars was an inter IIT event Come on, we heard you." image="/phone.png" link="https://www.iit.fun" imageClassName='col-span-3 mr-auto max-md:!col-span-4' />
        <Achievement/>
        <PartnersDiv/>
        </div>
    )
